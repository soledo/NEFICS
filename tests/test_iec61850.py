...
#     assert mms.haslayer('TPKT')
#     assert mms.haslayer('COTP')
#     assert mms.haslayer('COTP_CC')
#     # Check TPKT values
#     assert mms['TPKT'].getfieldval('version') == 3
#     assert mms['TPKT'].getfieldval('length')  == 22
#     # Check COTP headers
#     assert mms['COTP_CC'].getfieldval('length') == 17
#     assert (mms['COTP_CC'].getfieldval('TPDU') << 4) == 0xd0
#     assert mms['COTP_CC'].getfieldval('destination_reference') == 0x0001
#     assert mms['COTP_CC'].getfieldval('source_reference') == 0x0004
#     assert mms['COTP_CC'].getfieldval('class') == 0
#     assert bool(mms['COTP_CC'].getfieldval('extended_format')) is False
#     assert bool(mms['COTP_CC'].getfieldval('explicit')) is False
#     # Check COTP parameters
#     cotp_params = mms['COTP_CC'].getfieldval('parameters')
